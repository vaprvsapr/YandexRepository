...
namespace EventManager.Services
{
    ...
    public class BookingServiceDb(AppDbContext context, ILogger<EventServiceDb> logger) : IBookingService
    {
        private readonly AppDbContext _context = context;
        private readonly ILogger<EventServiceDb> _logger = logger;
        ...
        public async Task<List<BookingDto>> GetAllBookingsAsync()
        {
            ...
            return bookings.Select(BookingMapper.ToBookingDto).ToList();
        }
